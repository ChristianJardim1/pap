...
void executaP(char meminst[256][17], struct instrucao *inst, Deco *dec, int *pc, int *registrador, int *memdados,Stack *stack);
int executaI(char meminst[256][17], struct instrucao *inst, Deco *dec, int *pc, int *registrador, int *memdados,Stack *stack);
...
void executaP(char meminst[256][17], struct instrucao *inst, Deco *dec, int *pc, int *registrador, int *memdados,Stack *stack) {
	int j;
	for(int i=*pc;; i++) {
		executaI(meminst, inst, dec, pc, registrador, memdados,stack);
	}
}
